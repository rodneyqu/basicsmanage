...
addNucleicAcids($BiospeciemensID,$NucleicAcidSGIID,$NAExtractionAmount,$NAExtractionUnit,$NAExtractionDate,$NAExtractionManipulatorID,$NAVolume,$NAVolumeUnit,$NAConc,$NAConcUnit,$NAAmount,$NAAmountUnit,$NAQuality,$NAType,$Status);

function addNucleicAcids($BiospeciemensID,$NucleicAcidSGIID,$NAExtractionAmount,$NAExtractionUnit,$NAExtractionDate,$NAExtractionManipulatorID,$NAVolume,$NAVolumeUnit,$NAConc,$NAConcUnit,$NAAmount,$NAAmountUnit,$NAQuality,$NAType,$Status){
	...
	$result_all = $mysql_obj->insertq("NucleicAcids",$data);
